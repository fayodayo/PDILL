        ...
        <main v-else class="page-list">
            ...
            <div class="level-container">
                <div class="level" v-if="level">
                    ...
                    <h2>Records</h2>
                    <p v-if="selected + 1 <= 100000"><strong>{{ level.percentToQualify }}%</strong> or better to qualify</p>
                    <p v-else-if="selected +1 <= 200000"><strong>100%</strong> or better to qualify</p>
